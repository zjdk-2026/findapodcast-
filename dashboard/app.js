...
function actionButtonsHtml(match) {
  ...
  // ── PITCHED tab ──
    ...
    buttons.push(`<button type="button" class="btn btn-action-followup btn-xs" onclick="event.stopPropagation();openFollowUpModal('${id}');return false;">Follow Up</button>`);
  ...
  // ── FOLLOWED UP tab ──
    ...
    buttons.push(`<button type="button" class="btn btn-action-followup btn-xs" onclick="event.stopPropagation();openFollowUpModal('${id}');return false;">Follow Up Again</button>`);
    buttons.push(`<button class="btn btn-xs" style="background:#eff6ff;color:#2563eb;border:1.5px solid #bfdbfe;font-weight:600;" onclick="markReplied('${id}')">Host Replied</button>`);
    buttons.push(`<button class="btn btn-action-ignore btn-xs" onclick="confirmDismiss('${id}')">Not a Fit</button>`);
